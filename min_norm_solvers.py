...
class MinNormSolver:
    ...
    def _min_norm_element_from2(v1v1, v1v2, v2v2):
        """
        Solución analítica para min_{c} |cx_1 + (1-c)x_2|_2^2. d es la distancia 
        (objetivo) optimizada. 
        v1v1 = <x1,x1>. 
        v1v2 = <x1,x2>. 
        v2v2 = <x2,x2>
    ...
    def _min_norm_2d(vecs, dps):
        ...
        """Encuentra la solución de mínima norma como combinación de dos puntos.
        Esto es correcto solo en 2D. Es decir, min_c |\sum c_i x_i|_2^2 sujeto a 
        \sum c_i = 1, 1 >= c_1 >= 0 para todo i, c_i + c_j = 1.0 para algún i, j".
        dmin = 1e8"""
